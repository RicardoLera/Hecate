...
package function_rom is
  ...
  constant twiddle_lut   : s25_complex_array     (1 to n_points-1)                                      := build_twiddle;
  constant k_twiddle_lut : s25_real_array        (0 to n_points/4-1)                                    := build_k_twiddle;
  ...
  constant w_add_lut     : s25_complex_array     (1 to n_points-1)                                      := build_w_add_synth;
