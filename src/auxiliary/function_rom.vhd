...
package function_rom is
  ...
  constant twiddle_lut   : t_signed_complex_array (1 to n_points-1)                                      := build_twiddle;
  ...
  constant cordic_lut    : t_pfb_array_signed                                                            := build_cordic_arctan;

  attribute rom_style of
    scramble_lut, bfly_lut, wmul_lut, bfly_lut_rev, wmul_lut_rev, twiddle_lut, fft_nmul_lut, idft_nmul_lut, cordic_lut
  : constant is "block";
