...
\chapter{Literature Review}\label{ch:rev}
  ...
  \section{Convolution Algorithms}\label{sec:conv_alg}
    ...
    \begin{itemize}
      ...
      \\\todo{We are using the numeric citation system, so we CANNOT use footnotes of any kind (UOG pg. 56). Remove or re-structure those footnotes.}
    ...
    \subsection{Convolution-over-space \& Matrix Multiplication}
    ...
    \subsection{Coppersmith-Winograd}
